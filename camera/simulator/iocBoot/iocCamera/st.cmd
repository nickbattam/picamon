...
epicsEnvSet("PREFIX", "X2-CAM:")
epicsEnvSet("CAMID",  "192.168.42.106")
< st.cmd.camera

#-----------------------------------------------
# DATABASE SECTION
dbLoadRecords("${TOP}/db/CameraGeneric.db","CAMERA_NAME=X2-CAM, ARRAYSIZE=$(ARRAYSIZE)")
dbLoadRecords("${TOP}/db/CameraViewer.db","CAMERA_NAME=X2-CAM, XSIZE=$(XSIZE), YSIZE=$(YSIZE)")
dbLoadRecords("${TOP}/db/custom_centroid.db", "CAMERA_NAME=X2-CAM, SUFFIX=Centroid, ARRAYSIZE=$(ARRAYSIZE), XSIZE=$(XSIZE), YSIZE=$(YSIZE)")
dbLoadRecords("${TOP}/db/centroidSelect.db","CAMERA_NAME=X2-CAM, STATS=Stats1, ASUB=Centroid")
dbLoadRecords("${TOP}/db/centroidLock.db","CAMERA_NAME=X2-CAM")
dbLoadRecords("${TOP}/db/autoStreaming.db","CAMERA_NAME=X2-CAM")
dbLoadRecords("${TOP}/db/heartbeat.db","DEVICE=X2-CAM")
...
set_savefile_path("/home/swdev/HiLASE/live/../autosave/cameras/X2-CAM")
set_pass0_restoreFile("single_setting.sav")
set_pass1_restoreFile("single_setting.sav")
...
create_monitor_set("centroid.req", 5, "cam=X2-CAM, suffix=Centroid")
...
dbpf X2-CAM:cam1:PeakStepX 100
dbpf X2-CAM:cam1:PeakStepY 100
dbpf X2-CAM:cam1:PeakWidthX 125
dbpf X2-CAM:cam1:PeakWidthY 111
dbpf X2-CAM:cam1:PeakStartX 200
dbpf X2-CAM:cam1:PeakStartY 200
